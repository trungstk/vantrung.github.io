...
public class giohangadapter extends RecyclerView.Adapter<giohangadapter.giohangviewhodler> {
                    ...
                    builder.setMessage("Bạn có muốn xóa sản phẩm này ko")
                            .setPositiveButton("Xóa", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    API.API.Deletegiohang(giohang.getIdgh()).enqueue(new Callback<com.example.NUOCHOA.log_in.models.giohang>() {
                                        @Override
    ...
    private void put(int tongtien, giohang giohang,int sl) {
        ...
        API.API.Putgiohang(giohang.getIdgh(), giohang1).enqueue(new Callback<com.example.NUOCHOA.log_in.models.giohang>() {
            @Override
            public void onResponse(Call<com.example.NUOCHOA.log_in.models.giohang> call, Response<com.example.NUOCHOA.log_in.models.giohang> response) {
