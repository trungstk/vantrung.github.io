package com.example.NUOCHOA.API;

import com.example.NUOCHOA.log_in.models.chon;
import com.example.NUOCHOA.log_in.models.danh_muc;
...
public interface API {
    ...
    API API = new Retrofit.Builder().baseUrl("https://fastredtower60.conveyor.cloud/")
