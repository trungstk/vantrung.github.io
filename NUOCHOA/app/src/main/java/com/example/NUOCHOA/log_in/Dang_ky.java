package com.example.NUOCHOA.log_in;

import static com.example.NUOCHOA.xuly.dia;
import static com.example.NUOCHOA.xuly.on_back;
                    ...
                    API.API.kiemtra(email1, mk1).enqueue(new Callback<List<taikhoan>>() {
                        ...
                        public void onResponse(Call<List<taikhoan>> call, Response<List<taikhoan>> response) {
                            if (!response.isSuccessful()) {
                                ...
                                API.API.post_tk(taikhoan).enqueue(new Callback<com.example.NUOCHOA.log_in.models.taikhoan>() {
                                    @Override
                                    public void onResponse(Call<com.example.NUOCHOA.log_in.models.taikhoan> call, Response<com.example.NUOCHOA.log_in.models.taikhoan> response) {
                                        if (response.isSuccessful()) {
                                            dialog.dismiss();
                                    ...
                                    @Override
                                    public void onFailure(Call<com.example.NUOCHOA.log_in.models.taikhoan> call, Throwable t) {
                                        dialog.dismiss();
                                        Log.e("lỗi đăng ký", "" + t);
                                    }
                                });
